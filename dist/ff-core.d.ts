declare module scope.common {
    module Logger {
        let logLevel: string;
        function isLogLevelActive(msgLogLevel: any): boolean;
        ...
        function logMessage(msgType: string, msg: any, ...msgArgs: any[]): void;
        function emitDeprecationWarning(component: string, instead?: string): void;
    }
}
...
declare module scope.common {
    /**
     * Add a parameter to a specific property on the event object.
     * Duplicate values are removed.
     */
    function addParam(event: any, name: string, value: string): any;
    /**
     * Removes all duplicate entries from the array
     */
    function deduplicate(array?: Array<any>): any[];
    /**
    ...
    /**
     * This function is a workaround for the issue, that IE and Edge throw an error when accessing `history.state` within an iframe.
     * Be aware that just using main window here (do mainWindow = window.parent while mainWindow !== window.parent) needs adjustment to use main window in all places and some clean up of our leaking ff-custom-elements tests.
     *
     * @return {object} window.history.state or {} in the case window.history.state does throw or is falsy
     */
    ...
    function fireCustomEvent(eventName: string, canBubble: any, cancelable: any, element?: any, params?: any): void;
    function replaceAt(baseString: any, index: any, character: any): any;
    function removeAt(baseString: any, index: any, length: any): any;
    function randomString(length: any, characterSet?: string): string;
    function isFFParameter(paramName: string, isNg?: boolean): RegExpMatchArray | boolean;
    ...
    /**
     * Returns the meta-element key computed from navigation element's properties
     * @param element
     * @returns {string}
     */
...
declare module scope.communication {
    ...
    module Util {
        ...
        /** This wrapper enables mocking of readonly documentation.location.replace for testing purposes */
        ...
        /**
         * Retrieves category path field name using global search result is used to find category group.
         *  @return {string} field name suffixed with ROOT
         */
        function extractCategoryPathFieldName(): string;
        /**
        ...
        function isPriceField(associatedFieldName: string): boolean;
        var trackingHelper: {
    ...
    module ResultDispatcher {
        ...
        function addCallback(topic: any, fn: any, ctx: any): string;
    ...
    class Tracking12 {
        ...
        /**
         * Needed: id, sid, query, pos, origPos, page, origPageSize
        ...
        private handleEventRequest(eventName, event, requiredParams);
        private getWarningMessage(eventName, event, requiredParams);
    }
...
declare module scope.middleware.response {
     ...
     * */
    function ProductTeaserCampaignProcessor(): {
        topic: string;
        handler: (result: any) => void;
    };
}
declare function handler(result: any): void;
declare function getProductTeaserFeedbackTexts(campaigns: any): any;
declare function getFeedbackTextCampaigns(campaign: any): any;
declare module scope {
